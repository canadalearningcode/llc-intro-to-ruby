...
Created by [Sarah Beck](https://twitter.com/essefbeck) and [Trudy MacNabb]() based on Introduction to Python created by [Gabriel Gosselin](https://twitter.com/fggosselin) and [Darcie Milliken](https://twitter.com/derushie) for Ladies Learning Code.
